            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>Đổi mật khẩu</h2>
                        <p></p>
                        <s:form method="post" action="${pageContext.request.contextPath }/client/process-doiMK">
                            <div class="row">
								<div class="col-md-12">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="text" class="form-control" placeholder="Your Name" value="${userName }" readonly="true"/>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
                                    <div class="form-group">
										<h4 style="margin-bottom:-20px;">Mật khẩu mới
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="password" name="passNEW"  placeholder="Your password" class="form-control"/>
                                    </div>
                                </div>
                                <div class="col-md-12">
                                    <div class="form-group">
										<h4 style="margin-bottom:-20px;">nhập lại
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <input type="password"  name="passNewAgain" placeholder="Your password" class="form-control"/>
                                    </div>
                                </div>
                               
                                <div class="col-md-12">
                                    <div class="submit-button text-center">
                                        <button class="btn hvr-hover" id="submit" type="submit">Xác nhận</button>
