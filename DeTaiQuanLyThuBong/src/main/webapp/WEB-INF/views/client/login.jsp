			...
			<div class="row">
				<div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
					...
					<div class="our-link">
						...
						<c:if test="${!empty customer.firstName}">
							<ul>
								<li><a href="${pageContext.request.contextPath}/client/thongTinCaNhan/${customer.customerID}"><i class="fa fa-user s_color"></i> Account: ${customer.firstName} ${customer.lastName}</a></li>
            ...
            <div class="row">
                <div class="col-lg-8 col-sm-12">
                    <div class="contact-form-right">
                        <h2>Đăng nhập</h2>
                        <p></p>
                        <s:form method="post" action="${pageContext.request.contextPath }/client/process-login" modelAttribute="account">
                            <div class="row">
								<div class="col-md-12">
                                    <div class="form-group">
										<h4 style="margin-bottom:-20px;">Tên tài khoản
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <s:input type="text" class="form-control" path="userName" placeholder="Your Name"/>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                </div>
								<div class="col-md-12">
                                    <div class="form-group">
										<h4 style="margin-bottom:-20px;">Mật khẩu
											<c:if test="${!empty erroPass }">
												<span style="color:Red;">${erroPass }</span>
											</c:if>
										</h4>
                                        <div class="help-block with-errors"></div>
                                    </div>
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        <s:input type="password"  placeholder="Your password" class="form-control" path="password"/>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="submit-button text-center">
                                        <button class="btn hvr-hover" id="submit" type="submit">Đăng nhập</button>
                                         <a style="color:white;" href="${pageContext.request.contextPath}/client/dangKy" class="btn hvr-hover" id="submit" type="submit">Tạo tài khoản</a>
                                        <a style="color:white;" href="${pageContext.request.contextPath}/client/quenMK" class="btn hvr-hover" id="submit" type="submit">Quên mật khẩu</a>
				...
				<div class="col-lg-4 col-sm-12">
					<img src="${pageContext.request.contextPath }/resources/client/images/paddingTone.png">
                </div>
            </div>
        </div>
    </div>
