			...
			<div class="row">
				<div class="col-lg-8 col-sm-12">
					<div class="contact-form-right">
						...
						<p></p>
						<s:form method="post"
							action="${pageContext.request.contextPath }/client/xacMinhEmail">
							<div class="row">
								<div class="col-md-12">
						...
						<s:form method="post"
							action="${pageContext.request.contextPath }/client/xacMinhMa">
							<div class="row">
								<div class="col-md-12">
									<div class="form-group">
										<h4 style="margin-bottom: -20px;">
											Nhập mã xác minh
											<c:if test="${!empty errorMAXM }">
												<span style="color: Red;">${errorMAXM }</span>
											</c:if>
										</h4>
									</div>
								</div>
								<div class="col-md-12">
									<div class="form-group">
										<input type="text" name="maXM" class="form-control"
								...
								<div class="col-md-12">
									<div class="submit-button text-center">
										<button class="btn hvr-hover" id="submit" type="submit">xác minh</button>
										<a style="color:white;" href="${pageContext.request.contextPath}/client/login" class="btn hvr-hover" id="submit">Hủy</a>
										<div id="msgSubmit" class="h3 text-center hidden"></div>
										<div class="clearfix"></div>
									</div>
								</div>
