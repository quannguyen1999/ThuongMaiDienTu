		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					...
					<ul class="breadcrumb">
						<li class="breadcrumb-item"><a href="${pageContext.request.contextPath}/client">Trang chủ</a></li>
						<li class="breadcrumb-item active">Danh sách hóa đơn mua hàng</li>
					</ul>
				</div>
			</div>
		</div>
	...
	<div class="cart-box-main">
		<div class="container">
			<div class="row new-account-login">
				<c:forEach var="lichSuOrder" items="${listLichSuOrder}">
					<div class="col-sm-12 col-lg-12 mb-3">
						<div class="title-left">
							<h3>Mã order:<span style="color:red;">${lichSuOrder.orders.orderID}</span></h3>
						</div>
						<h5>
							<a data-toggle="collapse" href="#${lichSuOrder.orders.orderID}"
								role="button" aria-expanded="false">Bấm đây để xem</a>
						</h5>
						<form class="mt-3 collapse review-form-box"
							id="${lichSuOrder.orders.orderID}">
							<div class="form-row">
								<div class="form-group col-md-6">
									<label for="InputEmail" class="mb-0">Địa chỉ nhận</label> <input
										type="email" class="form-control" id="InputEmail"
										placeholder="Enter Email"
										value="${lichSuOrder.orders.customerID.address }"
										readonly="true">
								</div>
								<div class="form-group col-md-6">
									<label for="InputPassword" class="mb-0">Người nhận</label> <input
										type="text" class="form-control" id="InputPassword"
										placeholder="Password"
										value="${lichSuOrder.orders.customerID.firstName } ${lichSuOrder.orders.customerID.lastName }"
										readonly="true">
								</div>
									...
									<table class="table">
										...
										<tbody>
											<c:forEach var="orderDetailsProduct"
												items="${lichSuOrder.orderDetailsProduct }">
												<tr>
													<td class="thumbnail-img"><a href="#">
														<img class="img-fluid" src="data:image/png;base64,${orderDetailsProduct.products.picture}" width="50px;"
								height="50px;">
													</a></td>
													<td class="name-pr">
         ...
         maxFractionDigits = "3" value = "${orderDetailsProduct.products.unitPrrice}" />
														
													</td>
													<td class="price-pr">
														${orderDetailsProduct.orderDetails.quatity}
													</td>
													<td class="price-pr">
													<fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${orderDetailsProduct.products.unitPrrice}" />
									...
									<div class="order-box">
										...
										<div class="d-flex gr-total">
											...
											<div class="ml-auto h5">
													<fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${lichSuOrder.tongChiPhi}" /> đ
         									</div>
										</div>
										<hr>
									</div>
