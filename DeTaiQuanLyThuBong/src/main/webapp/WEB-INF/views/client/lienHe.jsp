			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbar-menu">
					<ul class="nav navbar-nav ml-auto" data-in="fadeInDown"
						...
						<li class="nav-item"><a style="color:#9932CC;" class="nav-link" href="${pageContext.request.contextPath}/client/lienHe">Liên hệ</a></li>
					</ul>
				</div>
				<!-- /.navbar-collapse -->
        ...
        <div class="container">
            <div class="my-account-page">
                        ...
                        <div class="account-box">
                            <div class="service-box">
                                ...
                                <div class="service-desc">
                                    <h4>Chi nhánh 1</h4>
                                    <p>219 Huỳnh Văn Bánh, P.12, Q. Phú Nhuận, HCM</p>
                                    <p>Sdt:0708821227</p>
                                </div>
                            </div>
                        </div>
					 ...
					 <div class="col-lg-6 col-md-12">
                        <div class="account-box">
                            <div class="service-box">
                                ...
                                <div class="service-desc">
                                    <h4>Chi nhánh 2</h4>
                                    <p>219 Huỳnh Văn Nghệ, P.12, Q.Gò vấp, HCM</p>
									<p>Sdt:0123421227</p>
                                </div>
                            </div>
                        </div>
                ...
                <div class="bottom-box">
                    <div class="row">
						 <div class="col-lg-12 col-md-12">
						<h1 style="text-align:center;">Thông tin chuyển khoản</h1>
					</div>
                            ...
                            <div class="account-box">
                                <div class="service-box">
                                    <div class="service-desc">
                                        ...
                                        <ul>
                                            <li> <a href="#">Stk:123910238192</a> </li>
                                            <li> <a href="#">Tên tk:lý hải phanh</a> </li>
                                            <li> <a href="#">chi nhánh:sài gòn</a> </li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
