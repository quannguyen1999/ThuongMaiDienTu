	...
	<div
		...
		<div class="app-main">
										...
										<tbody id="myTable">
											...
											<c:forEach var="product" items="${listProduct}">
												<tr>
													...
													<td>${product.categoryID.categoryID }</td>
         ...
         maxFractionDigits = "3" value = "${product.unitPrrice }" />đ
													...
													<td><img src="data:image/png;base64,${product.picture}" width="50px;"
								height="50px;"></td>
													<td><a
														href="<c:url value='/admin/sanPham/remove/${product.productID  }'/>"
														onclick="return confirm('Are you sure?')"
														class="btn btn-danger">Xóa</a> <a
														href="<c:url value='/admin/sanPham/edit/${product.productID }'/>"
		...
		function clickMyCart(){
			if(document.getElementById('startSide').style.display=="none"){
					document.getElementById("startSide").style="position:fixed;top:200px;right:0px;";
			}else{
