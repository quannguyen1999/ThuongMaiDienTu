								...
								<div class="col-md-4">
									<div class="main-card mb-3 card">
										<div class="card-body">
											...
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/sanPham/process-sua"
												...
												<div class="position-relative form-group">
													<label for="" class=""> Mã mặt hàng </label>
												...
												<div class="position-relative form-group">
													...
													<s:input path="categoryID.picture" style="display:none;" value="abc"/>
												</div>
