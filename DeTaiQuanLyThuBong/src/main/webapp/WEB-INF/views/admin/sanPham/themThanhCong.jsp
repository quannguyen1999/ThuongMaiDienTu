						...
						<div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="mb-2 mr-2 btn btn-primary btn-lg btn-block">Thêm sản phẩm thành công
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin/sanPham/danhSach" class="mb-2 mr-2 btn btn-primary btn-sm btn-block">Quay lại trang danh sách sản phẩm
                                        </a>
                                    </div>
                                </div>
						</div>
