								...
								<div class="col-md-12">
									<div class="main-card mb-3 card">
										<div class="card-body">
											...
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/suaAccount"
												>
												<div class="position-relative form-group">
													...
													<input name="userName"  readonly="true"
														...
														class="form-control" value="${pageContext.request.userPrincipal.name}"/>
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> password Old </label>
													<c:if test="${!empty errorPasswordOld}">
														<span style="color: red;">${errorPasswordOld }</span>
													</c:if>

													<input name="passwordOld"   id="exampleEmail"
														placeholder="Nhập mật khẩu cũ" type="password"
														class="form-control" />
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> password New </label>
													<c:if test="${!empty errorPasswordNew}">
														<span style="color: red;">${errorPasswordNew }</span>
													</c:if>

													<input name="passwordNew" id="exampleEmail"
														placeholder="Nhập khẩu mới" type="password"
														class="form-control" />
												</div>
												<button class="mt-1 btn btn-primary">Sửa</button>
												<a href="${pageContext.request.contextPath}/admin" class="btn btn-primary">Hủy</a>
											</s:form>
										</div>
									</div>
