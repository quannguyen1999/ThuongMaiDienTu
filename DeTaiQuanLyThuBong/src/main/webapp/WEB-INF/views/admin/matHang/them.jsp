							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="main-card mb-3 card">
										<div class="card-body">
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/matHang/process-them"
												modelAttribute="category" enctype="multipart/form-data">
												
												<h5 class="card-title">Tạo thông tin mặt hàng</h5>
												...
												<div class="position-relative form-group">
													...
													<s:input readonly="false" path="categoryID"
														placeholder="Nhập id" type="text" class="form-control" value="${MaCate}"/>
												</div>
												<div class="position-relative form-group">
