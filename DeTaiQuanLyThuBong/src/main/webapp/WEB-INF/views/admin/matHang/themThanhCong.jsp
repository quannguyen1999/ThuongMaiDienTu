						...
						<div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="mb-2 mr-2 btn btn-primary btn-lg btn-block">Thêm mặt hàng thành công
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin/matHang/danhSach" class="mb-2 mr-2 btn btn-primary btn-sm btn-block">Quay lại trang danh sách mặt hàng
                                        </a>
                                    </div>
                                </div>
						</div>
