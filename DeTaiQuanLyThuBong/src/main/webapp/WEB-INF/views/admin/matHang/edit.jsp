									...
									<div class="btn-group">
										<a data-toggle="dropdown" aria-haspopup="true"
											...
											height="40" class="rounded-circle"
												src="${pageContext.request.contextPath }/resources/client/images/logo.png" alt=""> <i
				...
				<div class="scrollbar-sidebar bg-plum-plate switch-sidebar-cs-class">
					<div class="app-sidebar__inner">
						<ul class="vertical-nav-menu ">
							...
							<li style="color: White; background-color: rgba(0, 0, 0, 0.6);"><a href="${pageContext.request.contextPath }/admin/matHang/danhSach"> <i
							...
							<div class="row">
								<div class="col-md-6">
									<div class="main-card mb-3 card">
										<div class="card-body">
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/matHang/process-sua"
												modelAttribute="category" enctype="multipart/form-data">

												<h5 class="card-title">Sửa thông tin mặt hàng</h5>

												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> Mã </label>
													<s:errors path="categoryID" cssClass="error" />
													<s:input readonly="false" path="categoryID"
														placeholder="Nhập id" type="text" class="form-control" />
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> tên mặt hàng </label>
													<s:errors path="categoryName" cssClass="error" />
													<s:input id="firstName" path="categoryName"
														placeholder="Nhập firstName" type="text"
														class="form-control" />
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> Mô tả </label>
													<s:errors path="Description" cssClass="error" />
													<s:textarea rows="10" id="lastName" path="Description"
								...
								<div class="col-lg-6">
									<div class="main-card mb-3 card">
										<div class="card-body">
										<h5 class="card-title">Danh sách sản phẩm của mặt hàng</h5>
											...
											<table class="mb-0 table">
												...
												<tbody id="myTable">
													<c:if test="${empty listProductLienQuan}">
														<th scope="row">1</th>
														<td colspan="7">không có danh sách nào</td>
													</c:if>
													<c:forEach var="product" items="${listProductLienQuan}">
														<tr>
															<td>${product.productID }</td>
															<td>${product.supplierID.supplierID }</td>
															<td>${product.productName }</td>
															<td><fmt:formatNumber type="number"
																	maxFractionDigits="3" value="${product.unitPrrice }" />đ
															</td>
															<td>${product.quatityInStock }</td>
															<td><img
																src="data:image/png;base64,${product.picture}"
																width="50px;" height="50px;"></td>
															<td><a
																href="<c:url value='/admin/matHang/remove/products/${product.productID  }'/>"
					...
					<div class="modal-body">
						...
						<div class="form-group">
							<label for="pwd">Password:</label> <input type="password"
								class="form-control" id="passwordOld"
								placeholder="nhập mật khẩu cũ" name="passwordOld">
						</div>
						<div class="form-group">
							<label for="pwd">Password:</label> <input type="password"
								class="form-control" id="passwordNew"
								placeholder="nhập mật khẩu mới" name="passwordNew">
						</div>
					</div>
					<div class="modal-footer">
						<input type="submit" /> <a class="btn btn-default"
