					...
					<div class="app-sidebar__inner">
						<ul class="vertical-nav-menu ">
							<li class="app-sidebar__heading" style="color: White;">Danh
								mục</li>
							<li ><a href="${pageContext.request.contextPath }/admin/khachHang/danhSach"> <i
							...
							<li style="color: White; background-color: rgba(0, 0, 0, 0.6);"><a href="${pageContext.request.contextPath }/admin/matHang/danhSach"> <i
									class="metismenu-icon pe-7s-drawer" style="color: White;"></i>
					...
					<div class="app-page-title">
						...
						<div class="page-title-wrapper">
							<div class="page-title-heading">
								...
								<div>
									Danh sách mặt hàng 
									<div class="page-title-subheading">Số lượng mặt hàng 
										${fn:length(listCate)}
                                 	</div>
                                 </div>
							</div>
							...
							<div class="page-title-actions">
								<a
									href="${pageContext.request.contextPath}/admin/matHang/them"
								...
								<div class="card-body">
									...
									<div class="input-group">
										...
										<input type="text" class="form-control"
											id="myInput"
											placeholder="Tìm kiếm trong mặt hàng"
									...
									<table class="mb-0 table">
										...
										<tbody id="myTable">
											<c:if test="${empty listCate}">
												<td colspan="4">không có danh sách nào</td>
											</c:if>
											<c:forEach var="category" items="${listCate}">
												<tr>
													...
													<td>
														<img src="data:image/png;base64,${category.picture}" width="50px;"
								height="50px;">
													</td>
													<td><a
														href="<c:url value='/admin/matHang/remove/${category.categoryID  }'/>"
														onclick="return confirm('Are you sure?')"
														class="btn btn-danger">Xóa</a> <a
														href="<c:url value='/admin/matHang/edit/${category.categoryID  }'/>"
