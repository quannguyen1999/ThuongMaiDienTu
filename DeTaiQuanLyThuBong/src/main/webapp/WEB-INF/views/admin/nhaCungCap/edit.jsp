							...
							<div class="row">
								...
								<div class="col-md-12">
									<div class="main-card mb-3 card">
										<div class="card-body">
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/nhaCungCap/process-sua"
												modelAttribute="supplier" enctype="multipart/form-data">
												<h5 class="card-title">Sửa thông tin nhà cung cấp</h5>
												...
												<div class="position-relative form-group">
													...
													<s:input id="firstName" path="companyName"
														placeholder="Nhập companyName" type="text"
														class="form-control" />
												</div>
												<div class="position-relative form-group">
