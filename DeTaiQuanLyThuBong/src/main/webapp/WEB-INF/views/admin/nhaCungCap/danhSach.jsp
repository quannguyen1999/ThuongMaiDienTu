								...
								<div class="widget-content-left">
									<div class="btn-group">
										...
										<div tabindex="-1" role="menu" aria-hidden="true"
											...
											<a href="${pageContext.request.contextPath }/admin/suanhà cung cấp" type="button" tabindex="0" class="dropdown-item">s tài khoản</a>
					...
					<div class="app-page-title">
						<div class="page-title-wrapper">
							...
							<div class="page-title-actions">
								<a
									href="${pageContext.request.contextPath}/admin/nhaCungCap/them"
							...
							<div class="main-card mb-3 card">
								<div class="card-body">
									...
									<table class="mb-0 table">
										...
										<tbody id="myTable">
											<c:if test="${empty listSupli}">
												<td colspan="7">không có danh sách nào</td>
											</c:if>
											<c:forEach var="supplier" items="${listSupli}">
												<tr>
													...
													<td><a
														href="<c:url value='/admin/nhaCungCap/remove/${supplier.supplierID }'/>"
														onclick="return confirm('Are you sure?')"
														class="btn btn-danger">Xóa</a> <a
														href="<c:url value='/admin/nhaCungCap/edit/${supplier.supplierID}'/>"
