						...
						<div class="page-title-wrapper">
							<div class="page-title-heading">
								<div class="page-title-icon">
									<i class="pe-7s-display2 icon-gradient bg-happy-itmeo"> </i>
								</div>
						...
						<div class="col-lg-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-body">
                                        ...
                                        <a href="#" class="mb-2 mr-2 btn btn-primary btn-lg btn-block">Thêm nhà cung cấp thành công
                                        </a>
                                        <a href="${pageContext.request.contextPath}/admin/nhaCungCap/danhSach" class="mb-2 mr-2 btn btn-primary btn-sm btn-block">Quay lại trang danh sách nhà cung cấp
                                        </a>
                                    </div>
                                </div>
						</div>
