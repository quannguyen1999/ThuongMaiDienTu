	...
	<div
								...
								<div class="widget-content-left">
									<div class="btn-group">
										...
										<div tabindex="-1" role="menu" aria-hidden="true"
											...
											<a href="${pageContext.request.contextPath }/admin-panel/logout" type="button" tabindex="0" class="dropdown-item">Đăng
												xuất</a>
										</div>
									</div>
								</div>
		...
		<div class="app-main">
			...
			<div style="text-align: center; padding-top: 20%;"
				...
				<h1
					style="color: white; font-size: 100px; transition: 2s; font-family: Brush Script MT, Brush Script Std, cursive;">Welcome</h1>
