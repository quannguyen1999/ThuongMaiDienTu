										...
										<div class="card-body">
											...
											<div class="input-group">
												...
												<input type="text" class="form-control" id="myInput"
													placeholder="Tìm kiếm trong account"
												...
												<tbody id="myTable">
													...
													<c:forEach var="product" items="${listProduct }">
														<tr>
															...
															<td>${product.unitPrrice }</td>
															<td>${product.quatityInStock }</td>
															<td><img src="data:image/png;base64,${product.categoryID.picture }</td>}" width="20px;"
								height="20px;"></td>
														</tr>
								...
								<div class="col-md-6">
									<div class="main-card mb-3 card">
										<div class="card-body">
											...
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/datHang/process-sua"
												modelAttribute="twoForm">
												<h5 class="card-title">Sửa thông tin hàng đặt</h5>
												...
												<div class="position-relative form-group">
													<label for="" class=""> Mã Khách hàng </label>
												...
												<div class="position-relative form-group">
													<label for="" class=""> Mã nhà cung cấp </label>
												...
												<div class="position-relative form-group">
													...
													<s:input id="lastName" path="quatityInStock"
														placeholder="Nhập Số lượng" type="text"
														class="form-control" />
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> Giá</label>
													<s:errors path="unitPrrice" cssClass="error" />
													<s:input id="email" path="unitPrrice" placeholder="Nhập giá"
