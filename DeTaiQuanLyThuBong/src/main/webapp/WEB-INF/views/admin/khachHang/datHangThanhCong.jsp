								...
								<div class="widget-content-left">
									<div class="btn-group">
										<a data-toggle="dropdown" aria-haspopup="true"
											aria-expanded="false" class="p-0 btn"> <img width="30"
											height="40" class="rounded-circle"
											src="assets/images/avatars/1.jpg" alt=""> <i
			...
			<div class="app-main__outer">
				<div class="app-main__inner">
					...
					<div class="row">
						<div class="col-lg-12">
							<div class="main-card mb-3 card">
								<div class="card-body">
									<h5 class="card-title">Trạng thái order</h5>
									...
									<div class="card-body">
										<div class="position-relative form-group">
											<label for="exampleEmail" class=""> Mã order</label> <input
												readonly="true" placeholder="Nhập Username" type="text"
												value="${idOrder}" class="form-control" />
										</div>
										<div class="position-relative form-group">
											<label for="exampleEmail" class=""> Mã khách hàng </label> <input
												readonly="true" placeholder="Nhập Username" type="text"
												value="${maKH}" class="form-control" />
										</div>
										<div class="position-relative form-group">
											<label for="exampleEmail" class=""> Tên khách hàng </label> <input
												readonly="true" placeholder="Nhập Username" type="text"
												value="${tenKH}" class="form-control" />
										</div>
										<div class="position-relative form-group">
											<label for="exampleEmail" class=""> Số điện thoại </label> <input
												readonly="true" placeholder="Nhập Username" type="text"
												value="${sdt}" class="form-control" />
										</div>
									</div>
								</div>
							</div>
					...
					<div class="col-lg-12">
						<div class="main-card mb-3 card">
							<div class="card-body">
								<h5 class="card-title">Danh sách các sản
												phẩm khách hàng mua</h5>
								...
								<li class="list-group-item">
									<div class="widget-content p-0">
										<div class="widget-content-outer">
											<div class="widget-content-wrapper">
												<div class="widget-content-left">
													<div class="widget-heading">Tổng</div>
													...
													<div class="widget-subheading">Giảm giá : 0</div>
												</div>
