						...
						<div class="tab-pane tabs-animation fade show active"
							...
							<div class="row">
								<div class="col-md-6 col-xl-4">
									<div class="card mb-3 widget-content">
										<div class="widget-content-outer">
											<div class="widget-content-wrapper">
												<div class="widget-content-left">
													<div class="widget-heading">Tên</div>
													<div class="widget-subheading">${customer.firstName}
								...
								<div class="col-md-6 col-xl-4">
									<div class="card mb-3 widget-content">
										<div class="widget-content-outer">
											<div class="widget-content-wrapper">
												<div class="widget-content-left">
													<div class="widget-heading">Địa chỉ</div>
													<div class="widget-subheading">${customer.address}</div>
												</div>
												<div class="widget-content-right">
													<div class="widget-numbers text-success">
														<div class="pe-7s-airplay"></div>
													</div>
												</div>
											</div>
										</div>
												...
												<tbody id="myTable">
													...
													<c:forEach var="product" items="${listProduct}">
														<tr>
															...
															<td><a
																href="<c:url value='/admin/khachHang/sanPhams/chon/${product.productID}'/>"
																class="btn btn-primary">Chọn</a></td>
														</tr>
													</c:forEach>
												</tbody>
											</table>
								...
								<div class="col-lg-6">
									<div class="main-card mb-3 card">
										<div class="card-body">
											<h5 class="card-title">hàng order</h5>
											<table class="mb-0 table">
												<thead>
													<tr>
														<th>Mã sp</th>
