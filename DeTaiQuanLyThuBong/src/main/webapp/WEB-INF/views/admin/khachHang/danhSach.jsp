...
<body>
	<div
									...
									<div class="btn-group">
										...
										<div tabindex="-1" role="menu" aria-hidden="true"
											...
											<a
												...
												khoản</a> <a
												href="${pageContext.request.contextPath }/admin-panel/logout"
					...
					<div class="app-page-title">
						<div class="page-title-wrapper">
							...
							<div class="page-title-actions">
								<a
									href="${pageContext.request.contextPath}/admin/khachHang/them"
									data-toggle="tooltip" title="Tạo mới" data-placement="bottom"
									class="btn-shadow mr-3 btn btn-dark">Thêm mới</a>
							</div>
						</div>
					</div>
					<div class="row">
								...
								<div class="card-body" style="overflow: auto">
									...
									<div class="input-group">
										<div class="input-group-prepend">
											<span class="input-group-text" id=""><div class=" pe-7s-search"></div></span>
										</div>
										...
										<tbody id="myTable">
											...
											<c:forEach var="customer" items="${listCustomer}">
												<tr>
													...
													<td><a
														href="<c:url value='/admin/khachHang/remove/${customer.customerID  }'/>"
														onclick="return confirm('Are you sure?')"
														class="btn btn-danger">Xóa</a> <a
														href="<c:url value='/admin/khachHang/edit/${customer.customerID  }'/>"
														class="btn btn-success">Sửa</a> <a
														href="<c:url value='/admin/khachHang/taoOrder/${customer.customerID  }'/>"
														class="btn btn-primary">Tạo order</a>
														<button type="button" class="btn btn-info"
															data-toggle="modal" data-target="#${customer.customerID}">Chi tiết</button></td>
												</tr>
											</c:forEach>
										</tbody>
		...
		<c:forEach var="customer" items="${listCustomer}">
		 <!-- Modal -->
													  <div class="modal fade" id="${customer.customerID}" role="dialog">
													    <div class="modal-dialog modal-lg">
													      <div class="modal-content">
													        ...
													        <div class="modal-body">
													          	<p>Mã khách hàng.</p>
													          	<input type="text" value="${customer.customerID}" readonly="true" class="form-control">
													          	<p>Tên khách hàng</p>
													          	<input type="text" value="${customer.firstName} ${customer.lastName}"  readonly="true"  class="form-control">
													          	<p>Email</p>
													          	<input type="text" value="${customer.email }"  readonly="true"  class="form-control">
													          	<p>Địa chỉ</p>
													          	<input type="text" value="${customer.address}"  readonly="true"  class="form-control">
													          	<p>Số điện thoại</p>
													          	<input type="text" value="${customer.phone }"  readonly="true"  class="form-control">
													          	<p>Tên tài khoản</p>
													          	<input type="text" value="${customer.userName.userName }"  readonly="true"  class="form-control">
													        </div>
