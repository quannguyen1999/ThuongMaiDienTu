							...
							<div class="row">
								<div class="col-lg-6 col-xl-6">
                                    <div class="card mb-3 widget-content">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Số lần order</div>
                                                <div class="widget-subheading">số lượng</div>
                                            </div>
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-success"><span>  ${fn:length(listSPOrder)} </span></div>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-lg-6 col-xl-6">
                                    <div class="card mb-3 widget-content">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left">
                                                <div class="widget-heading">Tổng số tiền khách hàng đã mua</div>
                                                <div class="widget-subheading">tổng</div>
                                            </div>
                                            <div class="widget-content-right">
                                                <div class="widget-numbers text-primary">
                                                	<span>
                                                		<fmt:formatNumber type = "number" 
         maxFractionDigits = "3" value = "${tongOrder}" /> đ
                                                	</span>
                                                </div>
                                            </div>
                                        </div>
								...
								<div class="col-md-6">
									<div class="main-card mb-3 card">
										<div class="card-body">
											...
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/khachHang/process-sua"
												...
												<div class="position-relative form-group">
													...
													<s:input path="userName.userName" readonly="true"
														placeholder="Nhập Username" type="text"
														class="form-control" />
												</div>
												...
												<div class="position-relative form-group">
													...
													<s:errors path="customerID" cssClass="error" />
													<s:input readonly="true" path="customerID"
												...
												<div class="position-relative form-group">
													...
													<s:input id="firstName" path="firstName"
												...
												<div class="position-relative form-group">
													...
													<s:input id="lastName" path="lastName"
													...
													<s:input id="lastName" path="phone"
												...
												<div class="position-relative form-group">
													...
													<s:input id="email" path="email" placeholder="Nhập email"
														type="text" class="form-control" />
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> Thành phố </label>
													<s:errors path="city" cssClass="error" />
													<s:input id="city" path="city" placeholder="Nhập thành phố"
														type="text" class="form-control" />
												</div>
												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> Địa chỉ </label>
													<s:errors path="address" cssClass="error" />
													<s:input id="address" path="address"
														placeholder="Nhập địa chỉ" type="text"
														class="form-control" />
												</div>

												<button class="mt-1 btn btn-primary">Sửa</button>
												<a
													href="${pageContext.request.contextPath }/admin/khachHang/danhSach"
							...
							<div class="main-card mb-3 card">
								<div class="card-body">
									...
									<table class="mb-0 table">
										...
										<tbody id="myTable">
											<c:if test="${empty listSPOrder}">
												<td colspan="7">không có danh sách nào</td>
											</c:if>
											<c:forEach var="order" items="${listSPOrder}">
												<tr>
													<td>${order.orderID }</td>
													<td>
														<fmt:formatDate value = "${order.orderDate }" var = "parsedEmpDate" pattern = "dd/MM/yyyy" />
														 <c:out value = "${parsedEmpDate}" />
													</td>
													<td>
														<fmt:formatDate value = "${order.shippedDate }" var = "parseShipdate" pattern = "dd/MM/yyyy" />
														 <c:out value = "${parseShipdate}" />
													</td>
													<td>${order.shipCity}</td>
													<td><a
														href="<c:url value='/admin/khachHang/edit/orders/${order.orderID}'/>"
