								...
								<div class="col-md-12">
									<div class="main-card mb-3 card">
										<div class="card-body">
											...
											<s:form method="post"
												action="${pageContext.request.contextPath}/admin/khachHang/process-them"
												...
												<div class="position-relative form-group">
													...
													<s:input path="userName.userName" readonly="false"
												...
												<div class="position-relative form-group">
													...
													<s:input path="userName.password" id="exampleEmail"
														placeholder="Nhập password" type="password"
														class="form-control" />
												</div>
												<h5 class="card-title">Tạo thông tin khách hàng</h5>

												<div class="position-relative form-group">
													<label for="exampleEmail" class=""> Mã </label>
													<s:errors path="customerID" cssClass="error" />
													<s:input readonly="false" path="customerID"
														placeholder="Nhập id" type="text" class="form-control" value="${maKH}"/>
												</div>
												<div class="position-relative form-group">
												...
												<div class="position-relative form-group">
													...
													<s:input id="tags" path="city" placeholder="Nhập thành phố"
														type="text" class="form-control" />
												</div>
												<div class="position-relative form-group">
